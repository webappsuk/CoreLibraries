    ...
    public sealed class XmlFormatter : IFormatter
    {
                                                                    ...
                                                                    FormatterConverter converter)
        {
            ...
            else if (objectToSerialize is ISerializable)
            {
                ...
                {
                    throw new SerializationException(string.Format(Resources.XmlFormatter_GetMemberInfo_TypeNotSerializable,
                                                                   objectType.FullName));
                }
        ...
        private object GetMemberValue(object item, MemberInfo member)
        {
            switch (member.MemberType)
            {
                ...
                default:
                    {
                        throw new NotSupportedException(string.Format(Resources.XmlFormatter_GetMemberValue_MemberCannotBeSerialized,
        ...
        private object InitializeObject(XmlTextReader reader, FormatterConverter converter, Type objectType)
        {
            ...
            else
            {
                ...
                while (reader.IsStartElement())
                {
                    ...
                    if (possibleMembers.Length > 1)
                        throw new SerializationException(string.Format(Resources.XmlFormatter_InitializeObject_MoreThanOneMemberFound,
                                                                       reader.Name));
                    ...
                    if (typeof (IList).IsAssignableFrom(possibleMembers[0].ReflectedType))
                    {
                        ...
                        if (list == null)
                            throw new SerializationException(string.Format(Resources.XmlFormatter_InitializeObject_MemberListIsNull,
