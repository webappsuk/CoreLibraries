...
{
    /// <summary>
    ///   Serialization surrogate used to serialize/deserialize <see cref="XmlElement"/>s.
    /// </summary>
    public class XmlElementSurrogate : ISerializationSurrogate
    {
        ...
        {
            info.AddValue("data", obj == null ? null : ((XmlElement) obj).OuterXml);
        }

        /// <summary>
        ///   Populates the object using the information in the <see cref="System.Runtime.Serialization.SerializationInfo"/>.
        /// </summary>
        /// <param name="obj">The object to populate using the deserialized data.</param>
        /// <param name="info">
        ...
        ///   There was a load or parse error in the XML.
        /// </exception>
