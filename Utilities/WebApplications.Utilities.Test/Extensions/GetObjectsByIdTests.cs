...
namespace WebApplications.Utilities.Test.Extensions
{
    ...
    public class GetObjectsByIdTests : UtilitiesTestBase
    {
        ...
        public void GetObjectsById_ValidList_OutputCountSameAsInput()
        {
            ...
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById should be equal to the number of distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById_ValidListAndCustomSeparator_OutputCountSameAsInput()
        {
            ...
            IEnumerable<int> resultEnumeration = csvList.GetObjectsById(n => n, new char[] { separator[0] });
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById should be equal to the number of distinct valid items in the input, separated by the specified separator.");
        }
        ...
        public void GetObjectsById_ListWithDuplicates_OutputCountSameAsDistinctInput()
        {
            ...
            Assert.AreEqual(listWithDuplicates.Distinct().Count(), resultEnumeration.Count(), "The number of items returned by GetObjectsById should be equal to the number of distinct valid items in the comma-seperated input.");
        }

        [TestMethod]
        public void GetObjectsById_ListWithDuplicatesWithoutExecuteImmediately_getObjectFuncNotCalledFromFunction()
        {
            var mock = new Mock<ITest<int, int>>();
            ...
            mock.Verify(m => m.Function(It.IsAny<int>()), Times.Never(), "Unless the executeImmediately argument is true, the getObjectFunction should not be called until the result is enumerated through.");
        }
        ...
        public void GetObjectsById_ListWithDuplicatesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            List<int> listWithDuplicates = AddDuplicatesToList(CreateRandomIdList());
            String csvListWithDuplicates = CreateListOfIds(listWithDuplicates);
            IEnumerable<int> resultEnumeration = csvListWithDuplicates.GetObjectsById(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<int>()), Times.Exactly(listWithDuplicates.Distinct().Count()), "The getObject function supplied to GetObjectsById should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById_ListWithInvalidEntriesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            IEnumerable<int> resultEnumeration = csvListWithBadValue.GetObjectsById(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<int>()), Times.Exactly(list.Count()), "The getObject function supplied to GetObjectsById should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById_getObjectFunctionReturnsNullableType_OutputCanContainNullValues()
        {
            ...
            Assert.IsTrue(resultEnumeration.Contains(null), "When the result of the getObject function is a nullable value type, null values should not be removed from the final output.");
        }
        ...
        public void GetObjectsById_getObjectFunctionReturnsNull_OutputDoesNotContainNullValues()
        {
            ...
            Assert.IsFalse(resultEnumeration.Contains(null), "When the result of the getObject function is null, these null values should be removed from the final output.");
        }
        ...
        public void GetObjectsById_getObjectFunctionReturnsNullOccasionally_OutputCountMatchesNumberOfNonNullValues()
        {
            ...
            IEnumerable<Object> resultEnumeration = csvList.GetObjectsById<Object>(n => n % 2 == 0 ? null : (Object)n);
            Assert.AreEqual(oddNumbers.Count, resultEnumeration.Count(), "When the result of the getObject function can be null, any null values should be removed from the final output.");
        }
        ...
        {
            return Enumerable.Range(1, Random.Next(5, 20)).Select(n => (short) Random.Next(0, maxId)).Distinct().ToList();
        }
        ...
        public void GetObjectsById16_ValidList_OutputCountSameAsInput()
        {
            ...
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById16 should be equal to the number of distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById16_ValidListAndCustomSeparator_OutputCountSameAsInput()
        {
            ...
            List<short> list = CreateRandomId16List();
            String csvList = CreateListOfIds(list, separator);
            IEnumerable<short> resultEnumeration = csvList.GetObjectsById16(n => n, new char[] { separator[0] });
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById16 should be equal to the number of distinct valid items in the input, separated by the specified separator.");
        }
        ...
        public void GetObjectsById16_ListWithDuplicates_OutputCountSameAsDistinctInput()
        {
            ...
            Assert.AreEqual(listWithDuplicates.Distinct().Count(), resultEnumeration.Count(), "The number of items returned by GetObjectsById16 should be equal to the number of distinct valid items in the comma-seperated input.");
        }

        [TestMethod]
        public void GetObjectsById16_ListWithDuplicatesWithoutExecuteImmediately_getObjectFuncNotCalledFromFunction()
        {
            var mock = new Mock<ITest<short, short>>();
            ...
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<short>()), Times.Never(), "Unless the executeImmediately argument is true, the getObjectFunction should not be called until the result is enumerated through.");
        }
        ...
        public void GetObjectsById16_ListWithDuplicatesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            List<short> listWithDuplicates = AddDuplicatesToList(CreateRandomId16List());
            String csvListWithDuplicates = CreateListOfIds(listWithDuplicates);
            IEnumerable<short> resultEnumeration = csvListWithDuplicates.GetObjectsById16(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<short>()), Times.Exactly(listWithDuplicates.Distinct().Count()), "The getObject function supplied to GetObjectsById16 should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById16_ListWithInvalidEntriesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            List<short> list = CreateRandomId16List();
            String csvListWithBadValue = CreateCommaSeperatedListWithBadValue(list);
            IEnumerable<short> resultEnumeration = csvListWithBadValue.GetObjectsById16(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<short>()), Times.Exactly(list.Count()), "The getObject function supplied to GetObjectsById16 should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById16_getObjectFunctionReturnsNullOccasionally_OutputCountMatchesNumberOfNonNullValues()
        {
            ...
            String csvList = CreateListOfIds(evenNumbers.Concat(oddNumbers));
            // The getObject function used here will return null for everything in the evenNumbers list, but non-null for all oddNumbers
            IEnumerable<Object> resultEnumeration = csvList.GetObjectsById16<Object>(n => n % 2 == 0 ? null : (Object)n);
            Assert.AreEqual(oddNumbers.Count, resultEnumeration.Count(), "When the result of the getObject function can be null, any null values should be removed from the final output.");
        }
        ...
        {
            return Enumerable.Range(1, Random.Next(5, 20)).Select(n => (long) (maxId*Random.NextDouble()) ).Distinct().ToList();
        }
        ...
        public void GetObjectsById64_ValidList_OutputCountSameAsInput()
        {
            ...
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById64 should be equal to the number of distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById64_ValidListAndCustomSeparator_OutputCountSameAsInput()
        {
            ...
            List<long> list = CreateRandomId64List();
            String csvList = CreateListOfIds(list, separator);
            IEnumerable<long> resultEnumeration = csvList.GetObjectsById64(n => n, new char[] { separator[0] });
            Assert.AreEqual(list.Count, resultEnumeration.Count(), "The number of items returned by GetObjectsById64 should be equal to the number of distinct valid items in the input, separated by the specified separator.");
        }
        ...
        public void GetObjectsById64_ListWithDuplicates_OutputCountSameAsDistinctInput()
        {
            ...
            Assert.AreEqual(listWithDuplicates.Distinct().Count(), resultEnumeration.Count(), "The number of items returned by GetObjectsById64 should be equal to the number of distinct valid items in the comma-seperated input.");
        }

        [TestMethod]
        public void GetObjectsById64_ListWithDuplicatesWithoutExecuteImmediately_getObjectFuncNotCalledFromFunction()
        {
            var mock = new Mock<ITest<long, long>>();
            ...
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<long>()), Times.Never(), "Unless the executeImmediately argument is true, the getObjectFunction should not be called until the result is enumerated through.");
        }
        ...
        public void GetObjectsById64_ListWithDuplicatesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            List<long> listWithDuplicates = AddDuplicatesToList(CreateRandomId64List());
            String csvListWithDuplicates = CreateListOfIds(listWithDuplicates);
            IEnumerable<long> resultEnumeration = csvListWithDuplicates.GetObjectsById64(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<long>()), Times.Exactly(listWithDuplicates.Distinct().Count()), "The getObject function supplied to GetObjectsById64 should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById64_ListWithInvalidEntriesAndExecuteImmediately_getObjectFuncCalledOncePerDistinctInput()
        {
            ...
            List<long> list = CreateRandomId64List();
            String csvListWithBadValue = CreateCommaSeperatedListWithBadValue(list);
            IEnumerable<long> resultEnumeration = csvListWithBadValue.GetObjectsById64(mock.Object.Function, executeImmediately: true);
            Assert.IsNotNull(resultEnumeration);
            mock.Verify(m => m.Function(It.IsAny<long>()), Times.Exactly(list.Count()), "The getObject function supplied to GetObjectsById64 should be called once for each of the distinct valid items in the comma-seperated input.");
        }
        ...
        public void GetObjectsById64_getObjectFunctionReturnsNullOccasionally_OutputCountMatchesNumberOfNonNullValues()
        {
            ...
            String csvList = CreateListOfIds(evenNumbers.Concat(oddNumbers));
            // The getObject function used here will return null for everything in the evenNumbers list, but non-null for all oddNumbers
            IEnumerable<Object> resultEnumeration = csvList.GetObjectsById64<Object>(n => n % 2 == 0 ? null : (Object)n);
            Assert.AreEqual(oddNumbers.Count, resultEnumeration.Count(), "When the result of the getObject function can be null, any null values should be removed from the final output.");
        }
