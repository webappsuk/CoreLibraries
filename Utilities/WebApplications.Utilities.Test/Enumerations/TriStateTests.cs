...
namespace WebApplications.Utilities.Test.Enumerations
{
    ...
    public class TriStateTests : UtilitiesTestBase
    {
        ...
        public void TriState_TrueState_IsEquivilantToYesAndPositive()
        {
            ...
            Assert.AreEqual(TriState.True, TriState.Positive, "The TriStates 'positive' and 'true' should be equivalent.");
        }
        ...
        public void TriState_FalseState_IsEquivilantToNoAndNegotive()
        {
            ...
            Assert.AreEqual(TriState.False, TriState.Negative, "The TriStates 'negotive' and 'false' should be equivalent.");
        }

        [TestMethod]
        public void TriState_UnknownState_IsEquivilantToUndefinedAndEqual()
        {
            Assert.AreEqual(TriState.Unknown, TriState.Undefined, "The TriStates 'undefined' and 'unknown' should be equivalent.");
            Assert.AreEqual(TriState.Unknown, TriState.Equal, "The TriStates 'equal' and 'unknown' should be equivalent.");
        }

        [TestMethod]
        public void TriState_DistinctStates_AreNotEquivilent()
        {
            Assert.AreNotEqual(TriState.Unknown, TriState.True, "The TriStates 'true' and 'unknown' should not be equivalent.");
            Assert.AreNotEqual(TriState.Unknown, TriState.False, "The TriStates 'false' and 'unknown' should not be equivalent.");
            Assert.AreNotEqual(TriState.True, TriState.False, "The TriStates 'false' and 'true' should not be equivalent.");
        }

        [TestMethod]
        public void TriState_ConstructorWithoutValue_DefaultsToUnknown()
        {
            Assert.AreEqual(TriState.Unknown, new TriState(), "A TriState instance with no value should be equivalent to 'unknown'.");
        }

        [TestMethod]
        public void TriState_DefaultValue_DefaultsToUnknown()
        {
            Assert.AreEqual(TriState.Unknown, default(TriState), "The default TriState value should be equivalent to 'unknown'.");
        }

        [TestMethod]
        public void TriState_YesTriState_CastsToTrue()
        {
            Assert.AreEqual(true, (bool)TriState.Yes, "The 'yes' TriState should be equal to True when cast to a boolean.");
        }

        [TestMethod]
        public void TriState_NoTriState_CastsToFalse()
        {
            Assert.AreEqual(false, (bool)TriState.No, "The 'no' TriState should be equal to False when cast to a boolean.");
        }
        ...
        {
            Assert.AreEqual(TriState.Yes, (TriState)true, "The boolean True should cast into the 'yes' TriState.");
        }

        [TestMethod]
        public void TriState_CastFromFalse_EquivilantToNo()
        {
            Assert.AreEqual(TriState.No, (TriState)false, "The boolean False should cast into the 'no' TriState.");
        }
        ...
        {
            Assert.AreEqual(0, (int)TriState.Unknown, "The 'unknown' TriState should be equal to 0 when cast to an int.");
        }
        ...
        {
            Assert.AreEqual(0, (byte)TriState.Unknown, "The 'unknown' TriState should be equal to 0 when cast to an byte.");
        }
        ...
        {
            Assert.AreEqual(TriState.Unknown, (TriState)((byte)(0)), "The byte 0 should cast into the 'unknown' TriState.");
        }

        [TestMethod]
        public void TriState_CastFromByteTwo_EquivilantToUnknown()
        {
            Assert.AreEqual(TriState.Unknown, (TriState)((byte)(2)), "The byte 2 should cast into the 'unknown' TriState.");
        }
        ...
        {
            TriState testTriState = (TriState)(Random.Next() % 3 - 1);
            Assert.AreEqual(testTriState.ToString(TriState.Style.YesUnknownNo),testTriState.ToString(),"The string representation of a TriState should default to YesUnknownNo formatting.");
        }
        ...
        {
            TriState testTriState = (TriState)(Random.Next() % 3 - 1);
            const TriState.Style testStyle = (TriState.Style) 4; // note: this test assumes there is no style with value 4
            Assert.AreEqual("4",testStyle.ToString(),"For this test to correctly function, the style used should be invalid. When this holds, the string representation of the style is a number.");
        ...
        {
            Assert.AreEqual("Yes", TriState.Yes.ToString(TriState.Style.YesUnknownNo), "The string representation of a Yes TriState with YesUnknownNo formatting should be 'Yes'.");
        }

        [TestMethod]
        public void TriState_NoStateToStringWithYesUnknownNoFormat_ReturnsNo()
        {
            Assert.AreEqual("No", TriState.No.ToString(TriState.Style.YesUnknownNo), "The string representation of a No TriState with YesUnknownNo formatting should be 'No'.");
        }

        [TestMethod]
        public void TriState_UnknownStateToStringWithYesUnknownNoFormat_ReturnsUnknown()
        {
            Assert.AreEqual("Unknown", TriState.Unknown.ToString(TriState.Style.YesUnknownNo), "The string representation of an Unknown TriState with YesUnknownNo formatting should be 'Unknown'.");
        }

        [TestMethod]
        public void TriState_YesStateToStringWithTrueUndefinedFalseFormat_ReturnsTrue()
        {
            Assert.AreEqual("True", TriState.Yes.ToString(TriState.Style.TrueUndefinedFalse), "The string representation of a Yes TriState with TrueUndefinedFalse formatting should be 'True'.");
        }

        [TestMethod]
        public void TriState_NoStateToStringWithTrueUndefinedFalseFormat_ReturnsFalse()
        {
            Assert.AreEqual("False", TriState.No.ToString(TriState.Style.TrueUndefinedFalse), "The string representation of a No TriState with TrueUndefinedFalse formatting should be 'False'.");
        }

        [TestMethod]
        public void TriState_UnknownStateToStringWithTrueUndefinedFalseFormat_ReturnsUndefined()
        {
            Assert.AreEqual("Undefined", TriState.Unknown.ToString(TriState.Style.TrueUndefinedFalse), "The string representation of an Unknown TriState with TrueUndefinedFalse formatting should be 'Undefined'.");
        }

        [TestMethod]
        public void TriState_YesStateToStringWithNegativeEqualPositiveFormat_ReturnsPositive()
        {
            Assert.AreEqual("Positive", TriState.Yes.ToString(TriState.Style.NegativeEqualPositive), "The string representation of a Yes TriState with NegativeEqualPositive formatting should be 'Positive'.");
        }

        [TestMethod]
        public void TriState_NoStateToStringWithNegativeEqualPositiveFormat_ReturnsNegative()
        {
            Assert.AreEqual("Negative", TriState.No.ToString(TriState.Style.NegativeEqualPositive), "The string representation of a No TriState with NegativeEqualPositive formatting should be 'Negative'.");
        }

        [TestMethod]
        public void TriState_UnknownStateToStringWithYesUnknownNoFormat_ReturnsEqual()
        {
            Assert.AreEqual("Equal", TriState.Unknown.ToString(TriState.Style.NegativeEqualPositive), "The string representation of an Unknown TriState with NegativeEqualPositive formatting should be 'Equal'.");
        }
        ...
        {
            TriState testTriState = (TriState)(Random.Next() % 3 - 1);
            Assert.AreEqual(testTriState.ToString("N", null), testTriState.ToString(TriState.Style.NegativeEqualPositive),
        ...
        public void TriState_IFormattableWithValidStyle_GivesSameResultAsToString()
        {
            ...
            TriState testTriState = (TriState)(Random.Next() % 3 - 1);
            TriState.Style testStyle = (new List<TriState.Style> { TriState.Style.YesUnknownNo, TriState.Style.NegativeEqualPositive, TriState.Style.TrueUndefinedFalse }).OrderBy(x => randSource.Next()).First();
        ...
        public void TriState_IFormattableWithInvalidStyle_ThrowsFormatException()
        {
            ...
            Assert.IsFalse(TriState.Style.TryParse(testInvalidStyle, false, out testStyle));
