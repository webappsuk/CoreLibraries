...
namespace WebApplications.Utilities
{
    ...
    public static partial class ExtendedTuple
    {
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<Type, Func<object, int, object>> _tupleIndexers = new ConcurrentDictionary<Type, Func<object, int, object>>();
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<Type, Type[]> _tupleTypes = new ConcurrentDictionary<Type, Type[]>();
        ...
        /// </summary>
        private static readonly ConcurrentDictionary<Type, Func<object, IEnumerable>> _tupleIterators = new ConcurrentDictionary<Type, Func<object, IEnumerable>>();
            ...
            return _tupleIterators.GetOrAdd(
                ...
                t =>
                {
                    ...
                    return Expression.Lambda<Func<object, IEnumerable>>(
                        Expression.New(constructor, castTuple).Convert(typeof(IEnumerable)), tupleObjectParameter).Compile();
                });
        }
    }
}