...
{
    /// <summary>
    ///   Provides extended functionality for <see cref="ConfigurationSection{T}"/>, as unknown child XML elements are
    ...
    /// </remarks>
    public class XmlConfigurationSection<T> : ConfigurationSection<T>
