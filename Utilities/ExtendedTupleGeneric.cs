...
namespace WebApplications.Utilities
{
        ...
        where T : class, IStructuralEquatable, IStructuralComparable, IComparable
    {
        ...
        /// </summary>
        [NotNull]
        public static Type[] Types { get { return (Type[])_types.Clone(); } }
        ...
        static ExtendedTuple()
        {
            ...
            if ((!tupleType.IsGenericType) ||
                ...
                throw new InvalidOperationException(String.Format(Resources.ExtendedTuple_TypeIsNotValidTuple, typeof(T)));
