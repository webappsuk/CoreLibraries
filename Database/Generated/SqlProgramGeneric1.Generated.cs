...
namespace WebApplications.Utilities.Database
{
    ...
    public class SqlProgram<T1> : SqlProgram
    {
        ...
        public async Task<SqlProgram<T1>> Create(
            [NotNull] LoadBalancedConnection connection,
            [NotNull] string name,
...
namespace WebApplications.Utilities.Database.Configuration
{
    ...
    {    
        ...
        /// <remarks></remarks>
        [NotNull]
        public static SqlProgram<T1> GetConfiguredSqlProgram<T1>(
            ...
            )
        {
            ...
            Contract.Requires(name != null);
            Contract.Requires(p1Name != null);
            return Active.GetSqlProgram<T1>(database, name, p1Name,
        ...
        /// <remarks></remarks>
        [NotNull]
        public SqlProgram<T1> GetSqlProgram<T1>(
            [NotNull] string database, 
            [NotNull] string name,
            [NotNull] string p1Name,
            bool ignoreValidationErrors = false,
