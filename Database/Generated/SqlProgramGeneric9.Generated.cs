...
namespace WebApplications.Utilities.Database.Configuration
{
    ...
    public partial class DatabaseElement : Utilities.Configuration.ConfigurationElement
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await SqlProgram<T1, T2, T3, T4, T5, T6, T7, T8, T9>.Create(connection, name, p1Name, p2Name, p3Name, p4Name, p5Name, p6Name, p7Name, p8Name, p9Name, ignoreValidationErrors, checkOrder, defaultCommandTimeout, (TypeConstraintMode) constraintMode, cancellationToken);
        }
    }
    #endregion
}
