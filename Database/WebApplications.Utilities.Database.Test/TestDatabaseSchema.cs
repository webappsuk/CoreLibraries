...
{
    [TestClass]
    public class TestDatabaseSchema : DatabaseTestBase
    {
        ...
        //public static readonly Connection Connection = new Connection(LocalDatabaseConnectionString);

        [TestMethod]
        [NotNull]
        public async Task TestSchemaEquality_SameSchema()
        {
            DatabaseSchema databaseSchema = await DatabaseSchema.GetOrAdd((Connection)LocalDatabaseConnectionString);
        ...
        [TestMethod]
        [NotNull]
        public async Task TestSchemaEquality_DifferentSchema()
        {
            DatabaseSchema databaseSchema = await DatabaseSchema.GetOrAdd((Connection)LocalDatabaseConnectionString);
            DatabaseSchema databaseSchema2 = await DatabaseSchema.GetOrAdd((Connection)(DifferentLocalDatabaseConnectionString));
            Assert.AreNotEqual(databaseSchema, databaseSchema2);
        }
        ...
        [TestMethod]
        public async Task Test_DatabaseProgramCall_ParamOrderMatters_CorrectOrderExecutesSuccessfully()
        {
            int rowCount = 0;
