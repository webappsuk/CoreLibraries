...
namespace WebApplications.Utilities.Logging {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The bufferCount must be greater than zero when an infinite bufferDuration is used..
        /// </summary>
        internal static string EmailLogger_InvalidBufferCount {
            get {
                return ResourceManager.GetString("EmailLogger_InvalidBufferCount", resourceCulture);
            }
        }
        ...
        internal static string EmailLogger_ToAddressMissing {
            get {
                return ResourceManager.GetString("EmailLogger_ToAddressMissing", resourceCulture);
            }
        }
        ...
        ///{!layout:f4}{time:{html}}{guid:{html}}{thread:{html}}{threadid:{html}}{exception:{html}}{innerexception:{html}}{sproc:{html}}{context:{html}}{stack:{html}}{!layout}&lt;/table&gt;.
        /// </summary>
        internal static string LogFormat_HTML {
            get {
                return ResourceManager.GetString("LogFormat_HTML", resourceCulture);
            }
        }
