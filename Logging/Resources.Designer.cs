...
namespace WebApplications.Utilities.Logging {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string PerformanceCounterHelper_Initialize_CategoryDoesNotExist {
            get {
                return ResourceManager.GetString("PerformanceCounterHelper_Initialize_CategoryDoesNotExist", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string PerformanceCounterHelper_Initialize_ProcessDoesNotHaveAccess {
            get {
                return ResourceManager.GetString("PerformanceCounterHelper_Initialize_ProcessDoesNotHaveAccess", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string PerformanceCounterHelper_Initialize_UnhandledExceptionOccurred {
            get {
                return ResourceManager.GetString("PerformanceCounterHelper_Initialize_UnhandledExceptionOccurred", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Performance Timer {0} exceeded critical level of {1} ms, operation took {2} ms..
        /// </summary>
        internal static string PerformanceTimer_Stop_ExceededCriticalLevel {
            get {
                return ResourceManager.GetString("PerformanceTimer_Stop_ExceededCriticalLevel", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Performance Timer {0} exceeded warning level of {1} ms, operation took {2} ms..
        /// </summary>
        internal static string PerformanceTimer_Stop_ExceededWarningLevel {
            get {
                return ResourceManager.GetString("PerformanceTimer_Stop_ExceededWarningLevel", resourceCulture);
            }
        }
        ...
        ///   Looks up a localized string similar to The current process identity does not have access to performance counters, disabling counters..
        /// </summary>
        internal static string PerformanceTimerHelper_Initialize_ProcessDoesNotHaveAccess {
            get {
                return ResourceManager.GetString("PerformanceTimerHelper_Initialize_ProcessDoesNotHaveAccess", resourceCulture);
            }
        }
