            ...
            bool isTable)
        {
            ...
            if (!IsUserDefined)
            {
                ...
                else
                {
                    ...
                    Trace.WriteLine(string.Format(Resources.SqlType_UnknownSqlSystemType, FullName));
                ...
                t =>
                {
                    ...
                    if (t == null)
                    {
                        ...
                        Trace.WriteLine(string.Format(
                            Resources.SqlType_GetClrToSqlConverter_NoTypeSpecified, this));
                        return null;
                    }
                    ...
                    try
                    {
                        ...
                        switch (SqlDbType)
                        {
                                ...
                                if (t.IsSerializable)
                                {
                                    return
                                        (c, m) =>
                                        {
                                            ...
                                            {
                                                formatter.Serialize(serializationStream, c);
                                                serializedObject = new byte[serializationStream.Length];
                                                long num = 0L;
                                                serializationStream.Seek(0L, SeekOrigin.Begin);
                                                while (num < serializationStream.Length)
                                                    serializedObject[num++] = Convert.ToByte(serializationStream.ReadByte());
                                            }
                            ...
                            case SqlDbType.Structured:
                                ...
                                return null;
                            default:
                                throw new InvalidOperationException(string.Format(Resources.SqlType_GetClrToSqlConverter_UnsupportedSqlDbType,
                                                                  SqlDbType));
                        }
                    }
                    catch (Exception e)
                    {
                        Trace.WriteLine(string.Format(Resources.SqlType_GetClrToSqlConverter_FatalErrorOccurred,
                                                    t,
                                                    this,
                                                    e.Message));
                    }
                ...
                converter = c =>
                                {
                                    if (c == null ||
                                        c == DBNull.Value)
                                        return DBNull.Value;
                                    INullable nullable = c as INullable;
                                    return nullable != null && nullable.IsNull ? DBNull.Value : conCopy(c);
                                };
            }
